...
MYSQL_CMD="mysql -uroot -p$DB_ROOT_PASS -e '$CREATE_DB_CMD'"
...
MYSQL_CMD="mysql -uroot -p$DB_ROOT_PASS -e '$CREATE_USER_GRANT_CMD'"
docker exec -i $DB_CONTAINER_NAME sh -c "$MYSQL_CMD"
...
MYSQL_CMD="mysql -uroot -p$DB_ROOT_PASS -e '$CREATE_FLUSH_USER_GRANT_CMD'"
docker exec -i $DB_CONTAINER_NAME sh -c "$MYSQL_CMD"
